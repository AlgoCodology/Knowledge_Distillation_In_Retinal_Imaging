...
# Creating the EfficientNet B1 model as student model
student_model = EfficientNetB1(weights='imagenet',include_top=False, input_shape=(512, 512, 3))
...
student_model = tf.keras.models.Model(inputs=student_model.input, outputs=student_predictions, name = 'EffNet_B1_imagenet_Glaucoma')
student_name = 'EffNet_B1_imagenet_Glaucoma'
...
student_model.fit(train_generator, steps_per_epoch=150,#steps_per_epoch=train_generator.n // train_generator.batch_size,
                            epochs=200, validation_data=validation_generator,
                            validation_steps = 150, #validation_steps=validation_generator.n // validation_generator.batch_size,
