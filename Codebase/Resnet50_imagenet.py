...
# Creating the EfficientNet B5 model as student model
student_model = ResNet50(weights='imagenet',include_top=False, input_shape=(512, 512, 3))
...
student_model = tf.keras.models.Model(inputs=student_model.input, outputs=student_predictions, name='Student_ResNet50')
student_name = 'ResNet50'
