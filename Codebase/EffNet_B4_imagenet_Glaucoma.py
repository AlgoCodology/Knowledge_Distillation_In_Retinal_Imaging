...
teacher_model = tf.keras.models.Model(inputs=teacher_model.input, outputs=teacher_predictions, name='EffNet_B4_imagenet_Glaucoma')
teacher_name = 'EffNet_B4_imagenet_Glaucoma'
...
teacher_model.fit(train_generator, steps_per_epoch=250,#steps_per_epoch=train_generator.n // train_generator.batch_size,
