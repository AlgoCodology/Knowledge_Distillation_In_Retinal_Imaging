...
# Creating the EfficientNet B7 model as teacher model
teacher_model = EfficientNetB7(weights='imagenet',include_top=False, input_shape=(512, 512, 3))
...
teacher_model = tf.keras.models.Model(inputs=teacher_model.input, outputs=teacher_predictions, name = 'EffNet_B7_imagenet_Glaucoma')
teacher_name = 'EffNet_B7_imagenet_Glaucoma'
...
teacher_model.fit(train_generator, steps_per_epoch=600,#steps_per_epoch=train_generator.n // train_generator.batch_size,
