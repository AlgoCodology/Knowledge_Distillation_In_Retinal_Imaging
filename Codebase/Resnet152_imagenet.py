...
teacher_model = ResNet152(weights='imagenet',include_top=False, input_shape=(512, 512, 3))
...
teacher_model = tf.keras.models.Model(inputs=teacher_model.input, outputs=teacher_predictions, name='Teacher_ResNet152')
