...
# Creating the EfficientNet B2 model as student model
student_model = EfficientNetB2(weights='imagenet',include_top=False, input_shape=(512, 512, 3))
...
student_model = tf.keras.models.Model(inputs=student_model.input, outputs=student_predictions, name = 'EffNet_B2_imagenet_Glaucoma')
student_name = 'EffNet_B2_imagenet_Glaucoma'
...
student_model.fit(train_generator, steps_per_epoch=200,#steps_per_epoch=train_generator.n // train_generator.batch_size,
