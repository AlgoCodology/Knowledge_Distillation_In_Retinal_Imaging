...
# Creating the EfficientNet B6 model as teacher model
teacher_model = EfficientNetB6(weights='imagenet',include_top=False, input_shape=(512, 512, 3))
...
teacher_model = tf.keras.models.Model(inputs=teacher_model.input, outputs=teacher_predictions, name = 'EffNet_B6_imagenet_Glaucoma')
teacher_name = 'EffNet_B6_imagenet_Glaucoma'
